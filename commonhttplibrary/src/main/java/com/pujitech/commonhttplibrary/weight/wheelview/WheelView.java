...
public class WheelView extends View {
     ...
     */
    public void setOnWheelChangingListener(OnWheelChangedListener listener) {
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        centerDrawable.setBounds(0, center - offset, getWidth(), center - offset + 1);
        centerDrawable.draw(canvas);
        centerDrawable.setBounds(0, center + offset - 1, getWidth(), center + offset);
        centerDrawable.draw(canvas);
    }
